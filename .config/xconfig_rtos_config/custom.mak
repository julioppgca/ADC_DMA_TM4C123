...
linker.cmd: package/cfg/rtos_config_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/rtos_config_pem4fcfg.cmd\)\"$""\"/Users/Julio/workspace_robotica/EX1_ADC_DMA_Project/.config/xconfig_rtos_config/\1\""' package/cfg/rtos_config_pem4f.xdl > $@
